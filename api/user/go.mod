module github.com/John-Tonny/mnhost/api/user
...
replace github.com/John-Tonny/mnhost/api/user/middleware => /root/mygo/src/github.com/John-Tonny/mnhost/api/user/middleware
